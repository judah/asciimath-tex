...
\begingroup
\catcode40=13
% Parses parentheses and places them inside of \parenContents;
% then runs #1.
% Eg \parenWrap\foo, creates tok list and calls \foo{...}
...
%\def\parenFunc{\parenWrap\parenFuncA}
%\def\parenFuncA#1{\def\todo{\parenFuncB{#1}}\futurelet\tokAfterParen\todo}
%\def\parenFuncB#1{\ifx\tokAfterParen/%
%    \def\todo{\
